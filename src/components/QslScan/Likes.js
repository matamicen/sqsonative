    ...
    render() { 
        ...
        return( <View style={{marginTop: 20}}>
              ...
              <View style={{flexDirection: 'row'}}>
                    ...
                    <Text style={{fontSize: 19, color:"grey", marginTop: 3  }} > {this.props.sqsoqslscan.likes.length} Likes </Text>
               </View > 
               { this.props.sqsoqslscan.likes.length>0 &&
               <Text style={{color:"grey", marginTop: 10 }}> These HAMs like this {this.props.sqsoqslscan.type} </Text>
                                     }
               </View>
              }
              ...
              <FlatList  style={styles.qralist }
                ...
                data={this.props.sqsoqslscan.likes}
