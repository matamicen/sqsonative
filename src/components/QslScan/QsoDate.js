...
class QsoDate extends Component {
...
//    {this.props.sqsoqslscan.datetime.substr(0,12)}
       console.log(JSON.stringify(this.props.sqsoqslscan));
        ...
        return <View >        
               ...
               <Text style={{ fontSize: 18, color: '#999'}}>Date:
               <Text style={{ fontSize: 18, color: 'orange'}}>  {this.props.sqsoqslscan.datetime.substr(0,12)} </Text>
