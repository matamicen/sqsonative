  ...
  _renderItem = ({ item }) => {
    ...
    render() { 
        ...
        return( <View style={{marginTop: 20}}>
               ...
               <View>
                    { this.props.sqsoqslscan.comments.length>0 &&
                    <View style={{flexDirection: 'row'}}>
                            <Image source={require('../../images/comment.png')} style={{height:23, width:23}}/> 
                            <Text style={{fontSize: 19, color:"grey"  }} > {this.props.sqsoqslscan.comments.length} Comments </Text>
                    </View > }
              ...
              <FlatList  style={styles.qralist }
                ...
                data={this.props.sqsoqslscan.comments}
